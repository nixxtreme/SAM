...
//            System.out.println(retorno);
    ...
    {
        String[] parametros = cadenaBD.split("\\|");
        String statement = "create table AdminUsrAdminGenSAP (Usuario varchar(45), nombre varchar(255), apellido varchar(255),\n" +
    ...
    {
        String[] parametros = cadenaBD.split("\\|");
        String statement = "create table AdminUsrAdminSAP (Usuario varchar(45), nombre varchar(255), apellido varchar(255),\n" +
